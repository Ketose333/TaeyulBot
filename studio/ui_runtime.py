...
UI_TARGETS = {
    'cron': {
        'port': _PORTS['cron'],
        'cmd': ['python3', str(WORKSPACE / 'studio' / 'dashboard' / 'webui.py'), '--host', '0.0.0.0', '--port', str(_PORTS['cron'])],
    },
    'shorts': {
        'port': _PORTS['shorts'],
        'cmd': ['python3', str(WORKSPACE / 'studio' / 'shorts' / 'webui.py'), '--host', '0.0.0.0', '--port', str(_PORTS['shorts'])],
    },
    'image': {
        'port': _PORTS['image'],
        'cmd': ['python3', str(WORKSPACE / 'studio' / 'image' / 'webui.py'), '--host', '0.0.0.0', '--port', str(_PORTS['image'])],
    },
    'music': {
        'port': _PORTS['music'],
        'cmd': ['python3', str(WORKSPACE / 'studio' / 'music' / 'webui.py'), '--host', '0.0.0.0', '--port', str(_PORTS['music'])],
    },
}
