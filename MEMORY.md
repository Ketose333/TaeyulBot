...
- 모델/fallback/시스템 설정 변경은 사용자 현재 턴 명시 지시 + 적용 범위 재확인 후에만 수행
...
- TTS 우선순위: `studio/gemini_tts.py` 기반 Gemini TTS 강제 우선, OpenAI TTS는 사용 금지, 기본 보이스는 Fenrir 고정(사용자 요청 시만 변경)
